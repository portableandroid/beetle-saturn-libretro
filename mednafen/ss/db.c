...
} cartdb[] =
{
 ...
 //
 // NetLink Modem TODO:
 { "MK-81218", NULL, CART_NONE, "Daytona USA CCE Net Link Edition", "Reserved for future modem support." },
 { "MK-81071", NULL, CART_NONE, "Duke Nukem 3D", "Reserved for future modem support." },
 { "T-319-01H", NULL, CART_NONE, "PlanetWeb Browser (multiple versions)", "Reserved for future modem support." },
 { "MK-81070", NULL, CART_NONE, "Saturn Bomberman", "Reserved for future modem support." },
 { "MK-81215", NULL, CART_NONE, "Sega Rally Championship Plus NetLink Edition", "Reserved for future modem support." },
 { "MK-81072", NULL, CART_NONE, "Virtual On NetLink Edition", "Reserved for future modem support." },
 //
 //
 // Japanese modem TODO:
 { "GS-7106", NULL, CART_NONE, "Dennou Senki Virtual On (SegaNet)", "Reserved for future modem support." },
 { "GS-7114", NULL, CART_NONE, "Dragon's Dream (Japan)", "Reserved for future modem support." },
 { "GS-7105", NULL, CART_NONE, "Habitat II (Japan)", "Reserved for future modem support." },
 { "GS-7101", NULL, CART_NONE, "Pad Nifty (Japan)", "Reserved for future modem support." },
 { "GS-7113", NULL, CART_NONE, "Puzzle Bobble 3 (SegaNet)", "Reserved for future modem support." },
 { "T-14305G", NULL, CART_NONE, "Saturn Bomberman (SegaNet)", "Reserved for future modem support." },
 { "T-31301G", NULL, CART_NONE, "SegaSaturn Internet Vol. 1 (Japan)", "Reserved for future modem support." },
 //
 //
 // ROM carts:
 { "MK-81088", NULL, CART_KOF95, "King of Fighters '95, The (Europe)", "Game requirement." },
 { "T-3101G", NULL, CART_KOF95, "King of Fighters '95, The (Japan)", "Game requirement." },
 { "T-13308G", NULL, CART_ULTRAMAN, "Ultraman - Hikari no Kyojin Densetsu (Japan)", "Game requirement." },
 //
 //
 // 1MiB RAM cart:
 ...
 { "GS-9107", NULL, CART_EXTRAM_1M, "Fighter's History Dynamite (Japan)", "Game requirement." },
 { "T-20109G", NULL, CART_EXTRAM_1M, "Friends (Japan)" },		// Would 4MiB be better?
 { "T-14411G", NULL, CART_EXTRAM_1M, "Groove on Fight (Japan)", "Game requirement." },
 { "T-7032H-50", NULL, CART_EXTRAM_1M, "Marvel Super Heroes (Europe)" },
 { "T-1215G", NULL, CART_EXTRAM_1M, "Marvel Super Heroes (Japan)" },
 { "T-3111G", NULL, CART_EXTRAM_1M, "Metal Slug (Japan)", "Game requirement." },
 { "T-22205G", NULL, CART_EXTRAM_1M, "NOël 3 (Japan)" },
 { "T-20114G", NULL, CART_EXTRAM_1M, "Pia Carrot e Youkoso!! 2 (Japan)" },
 { "T-3105G", NULL, CART_EXTRAM_1M, "Real Bout Garou Densetsu (Japan)", "Game requirement." }, //  Incompatible with 4MiB extended RAM cart.
 { "T-99901G", "REAL BOUT", CART_EXTRAM_1M, "Real Bout Garou Densetsu Demo (Japan)", "Game requirement." }, //  Incompatible with 4MiB extended RAM cart.
 { "T-3119G", NULL, CART_EXTRAM_1M, "Real Bout Garou Densetsu Special (Japan)", "Game requirement." },
 { "T-3116G", NULL, CART_EXTRAM_1M, "Samurai Spirits - Amakusa Kourin (Japan)", "Game requirement." }, // Incompatible with 4MiB extended RAM cart.
 { "T-3104G", NULL, CART_EXTRAM_1M, "Samurai Spirits - Zankurou Musouken (Japan)", "Game requirement." },
 { "610636008", NULL, CART_EXTRAM_1M,"Tech Saturn 1997.6 (Japan)", "Required by \"Groove on Fight\" demo." },
 ...
 { "T-3108G", NULL, CART_EXTRAM_1M, "The King of Fighters '96 (Japan)", "Game requirement." },
 { "T-3121G", NULL, CART_EXTRAM_1M, "The King of Fighters '97 (Japan)", "Game requirement." },
 { "T-1515G", NULL, CART_EXTRAM_1M, "Waku Waku 7 (Japan)", "Game requirement." },
 //
 //
 // 4MiB RAM cart:
 { "T-1245G", NULL, CART_EXTRAM_4M, "Dungeons and Dragons Collection (Japan)", "Game requirement(\"Shadow over Mystara\")." },
 { "T-1248G", NULL, CART_EXTRAM_4M, "Final Fight Revenge (Japan)", "Game requirement." },
 { "T-1238G", NULL, CART_EXTRAM_4M, "Marvel Super Heroes vs. Street Fighter (Japan)", "Game requirement." },
 { "T-1230G", NULL, CART_EXTRAM_4M, "Pocket Fighter (Japan)" },
 { "T-1246G", NULL, CART_EXTRAM_4M, "Street Fighter Zero 3 (Japan)", "Game requirement." },
 { "T-1229G", NULL, CART_EXTRAM_4M, "Vampire Savior (Japan)", "Game requirement." },
 { "T-1226G", NULL, CART_EXTRAM_4M, "X-Men vs. Street Fighter (Japan)", "Game requirement." },
 //
 //
 //
 ...
 //
 // Backup memory cart:
 { "T-16804G", NULL, CART_BACKUP_MEM, "Dezaemon 2 (Japan)", "Allows saving." },	// !
 { "GS-9123", NULL, CART_BACKUP_MEM,	"Die Hard Trilogy (Japan)", "Game will crash when running with a RAM expansion cart." }, // !
 { "T-16103H", NULL, CART_BACKUP_MEM,	"Die Hard Trilogy (Europe/USA)", "Game will crash when running with a RAM expansion cart." }, // !
 { "T-26104G", NULL, CART_BACKUP_MEM, "Kouryuu Sangoku Engi (Japan)" }, // !
 { "GS-9197", NULL, CART_BACKUP_MEM,	"Sega Ages - Galaxy Force II", "Allows saving replay data." }, // !
#if 0
 ...
 { "T-18612G", NULL, CART_BACKUP_MEM,	"Hexen (Japan)", "Allows saving." }, // !
 { "T-25406H", NULL, CART_BACKUP_MEM,	"Hexen (USA)", "Allows saving." }, // !
 { "T-25405H50", NULL, CART_BACKUP_MEM,"Hexen (Europe)", "Allows saving." }, // !
...
} cemdb[] =
{
 ...
 { "T-25408H",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Area 51 (Europe)", "Fixes game hang." },
 { "MK-81036",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Clockwork Knight 2 (USA)", "Fixes game hang that occurred when some FMVs were played." },
 { "T-01304H",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Creature Shock - Special Edition (USA)", "Fixes game crash when trying to start a level." },
 { "T-30304G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "DeJig - Lassen Art Collection (Japan)", "Fixes graphical glitches." },
 { "T-19801G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Doraemon - Nobita to Fukkatsu no Hoshi (Japan)", "Fixes blank Game Over screen." },
 { "GS-9184",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Dragon Force II (Japan)", "Fixes math and game logic errors during battles." },
 { "T-18504G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Father Christmas (Japan)", "Fixes stuck music and voice acting." },
 { "GS-9101",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Fighting Vipers (Japan)", "Fixes computer-controlled opponent turning into a ghost statue." },
 { "MK-81041",  NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Fighting Vipers (Europe/USA)", "Fixes computer-controlled opponent turning into a ghost statue." },
 { "T-7309G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Formula Grand Prix - Team Unei Simulation (Japan)", "Fixes game hang." },
 { "MK-81045",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Golden Axe - The Duel (Europe/USA)", "Fixes flickering title screen." },
 { "GS-9041",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Golden Axe - The Duel (Japan)", "Fixes flickering title screen." },
 { "GS-9173",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"House of the Dead (Japan)", "Fixes game crash on lightgun calibration screen." },
 { "GS-9017",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Kanzen Chuukei Pro Yakyuu Greatest Nine (Japan)", "Fixes game hang." },
 { "GS-9055",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Linkle Liver Story (Japan)", "Fixes game crash when going to the world map." },
 { "T-5006H",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Magic Carpet (Europe)", "Fixes game hang." },
 { "T-25302G1", NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Mahjong Doukyuusei Special (Japan)",	"Fixes missing background layer on disc 2." },
 { "T-25302G2", NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Mahjong Doukyuusei Special (Japan)",	"Fixes missing background layer on disc 2." },
 { "MK-81210",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Manx TT SuperBike (Europe)", "Fixes game crash during optional intro movie." },
 { "T-28901G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Mujintou Monogatari R - Futari no Love Love Island (Japan)", "Fixes glitches when character graphics change." },
 { "T-14415G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Ronde (Japan)", "Fixes missing graphics on the title screen, main menu, and elsewhere." },
 { "610602002",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Saturn Super Vol. 2 (Japan)", "Fixes flickering title screen in the \"Golden Axe - The Duel\" demo." },
 { "81600",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Sega Saturn Choice Cuts (USA)", "Fixes FMV playback hangs and playback failures." },
 { "610680501", NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Segakore Sega Bible Mogitate SegaSaturn (Japan)", "Fixes graphical glitch on the character select screen in the \"Zero Divide\" demo." },
 { "T-18703G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Shunsai (Japan)", "Fixes various graphical glitches." },
 { "T-7001H",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Spot Goes to Hollywood (USA)", "Fixes hang at corrupted \"Burst\" logo." },
 { "T-7014G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Spot Goes to Hollywood (Japan)", "Fixes hang at corrupted \"Burst\" logo." },
 // Nooo, causes glitches: { "T-7001H-50",CPUCACHE_EMUMODE_DATA_CB,	"Spot Goes to Hollywood (Europe)
 { "T-1206G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Street Fighter Zero (Japan)", "Fixes weird color/palette issues during game startup." },
 { "T-1246G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Street Fighter Zero 3 (Japan)", "" },	// ? ? ?
 { "T-1215H",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Super Puzzle Fighter II Turbo (USA)", "Fixes color/brightness and other graphical issues." },
 { "T-5001H",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Theme Park (Europe)", "Fixes hang during FMV." },
 { "T-1808G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Thunder Force Gold Pack 2 (Japan)", "Fixes hang when pausing the game under certain conditions in \"Thunder Force AC\"." },
 { "GS-9079","VF. KIDS",NULL,CPUCACHE_EMUMODE_DATA_CB,"Virtua Fighter Kids (Japan/Europe)", "Fixes FMV glitches." },
 { "GS-9113","VF. KIDS",NULL,CPUCACHE_EMUMODE_DATA_CB,"Virtua Fighter Kids (Korea/Java Tea Original)", "Fixes FMV glitches and/or malfunction of computer-controlled player." },
 { "MK-81049","VF. KIDS",NULL,CPUCACHE_EMUMODE_DATA_CB,"Virtua Fighter Kids (USA)", "Fixes FMV glitches." },
 { "T-2206G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Virtual Mahjong (Japan)", "Fixes graphical glitches on the character select screen." },
 { "T-15005G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Virtual Volleyball (Japan)", "Fixes invisible menu items and hang." },
 { "T-18601H",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"WipEout (USA)", "Fixes hang when trying to exit gameplay back to the main menu." },
 { "T-18603G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"WipEout (Japan)", "Fixes hang when trying to exit gameplay back to the main menu." },
 { "T-11301H",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"WipEout (Europe)", "Fixes hang when trying to exit gameplay back to the main menu." },
 { "GS-9061",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"Hideo Nomo World Series Baseball (Japan)", "Fixes severe gameplay logic glitches." },
 { "MK-81109",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB,	"World Series Baseball (Europe/USA)", "Fixes severe gameplay logic glitches." },
 { "T-31601G",	NULL, NULL, CPUCACHE_EMUMODE_DATA_CB, "Zero Divide - The Final Conflict (Japan)", "Fixes graphical glitch on the character select screen." },
 //{ "MK-81019", NULL, NULL, CPUCACHE_EMUMODE_DATA },	// Astal (USA)
 //{ "GS-9019",  CPUCACHE_EMUMODE_DATA },	// Astal (Japan)

 { "T-15906H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "3D Baseball (USA)", "Fixes minor FMV glitches." },
 { "T-18003G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "3D Baseball - The Majors (Japan)", "Fixes minor FMV glitches." },
 { "T-1507G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Albert Odyssey (Japan)", "" },
 { "T-12705H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Albert Odyssey (USA)", "Fixes battle text truncation." },
 //{ "MK-81501",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Baku Baku Animal (Europe)", "Fixes hang when trying to watch a movie in the \"Movie Viewer\"." },
 { "T-16201H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Corpse Killer (USA)", "Fixes glitchy rotation-zoom effect." },
 { "T-8124H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Crow, The (USA)", "Fixes minor FMV glitches." },
 { "T-8124H-50",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Crow, The (Europe)", "Fixes minor FMV glitches." },
 { "T-8124H-18",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Crow, The (Germany)", "Fixes minor FMV glitches." },
 { "T-36101G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Dark Seed II (Japan)", "Fixes game hang." },
 { "GS-9123",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Die Hard Trilogy (Japan)", "Fixes game hang." },
 { "T-16103H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Die Hard Trilogy (Europe/USA)", "Fixes game hang." },
 // Not needed in 1.26.0, and actually causes a game hang, probably due to lack of SCI emulation messing up game timing: { "T-13331G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Digital Monster Version S (Japan)", "Fixes game hang." },
 { "T-29101G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Gal Jan (Japan)", "Fixes game hang after game ends." },
 { "T-4504G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Gambler Jiko Chuushinha - Tokyo Mahjongland", "Fixes flickering octopus screen." },
 { "T-13310G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "GeGeGe no Kitarou (Japan)", "Fixes game hang." },
 { "T-15904G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Gex (Japan)",		"Fixes minor FMV glitches."  },
 { "T-15904H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Gex (USA)",		"Fixes minor FMV glitches." },
 { "T-15904H50",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Gex (Europe)",		"Fixes minor FMV glitches." },
 { "T-24301G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Horror Tour (Japan)",	"Fixes graphical glitches on the save and load screens." },
 { "T-22403G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Irem Arcade Classics (Japan)", "Fixes hang when trying to start \"Zippy Race\"." },
 { "GS-9142",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Kidou Senkan Nadesico - Yappari Saigo wa Ai ga Katsu", "Fixes game hang." },
 { "GS-9162",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "The Lost World - Jurassic Park (Japan)", "Fixes most graphical glitches in rock faces." },
 { "MK-81065",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "The Lost World - Jurassic Park (Europe/USA)", "Fixes most graphical glitches in rock faces." },
 { "T-27901G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Lunar - Silver Star Story (Japan)", "Fixes FMV flickering." },
 { "MK-81103",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "NBA Action (USA)", "Fixes minor FMV glitches." },
 { "MK81103-50",NULL, NULL, CPUCACHE_EMUMODE_FULL, "NBA Action (Europe)", "Fixes minor FMV glitches." },
 { "T-8105G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "NFL Quarterback Club 96 (Japan)", "Fixes minor FMV glitches." },
 { "T-8109H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "NFL Quarterback Club 96 (USA)", "Fixes minor FMV glitches." },
 ...
 { "T-8107H-18",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Revolution X - Music Is the Weapon (Germany)", "Fixes game hang." },
 { "T-37401G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Senken Kigyouden (Japan)", "Fixes dialogue text truncation." },
 { "T-37401H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Xian Jian Qi Xia Zhuan (Taiwan)", "Fixes dialogue text truncation." },
 { "T-30902G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Senkutsu Katsuryu Taisen - Chaos Seed (Japan)", "Fixes inability to skip intro FMV." },
 { "T-159056",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Slam 'n Jam 96 (Japan)", "Fixes minor FMV glitches." },
 { "T-159028H", NULL, NULL, CPUCACHE_EMUMODE_FULL, "Slam 'n Jam 96 (USA)",	"Fixes minor FMV glitches." },
 { "T-15902H50",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Slam 'n Jam 96 (Europe)", "Fixes minor FMV glitches." },
 { "T-8119G", 	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Space Jam (Japan)", 	"Fixes game crash." },
 { "T-8125H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Space Jam (USA)", 	"Fixes game crash." },
 { "T-8125H-50",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Space Jam (Europe)", 	"Fixes game crash." },
 { "T-1807G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Thunder Force Gold Pack 1 (Japan)", "In \"Thunder Force III\", fixes explosion graphic glitches throughout the game and ship sprite glitches in the ending sequence." },
 { "T-15903G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Titan Wars (Japan)",	"Fixes minor FMV glitches." },
 { "T-15911H",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Solar Eclipse (USA)",	"Fixes minor FMV glitches." },
 { "T-15911H50",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Titan Wars (Europe)",	"Fixes minor FMV glitches." },
 { "MK-81015",	NULL, "E",  CPUCACHE_EMUMODE_FULL, "Virtua Cop (Europe)", "Fixes game hang." },
 { "MK-81043",	NULL, "E",  CPUCACHE_EMUMODE_FULL, "Virtua Cop 2 (Europe)", "Fixes game hang." },
 { "GS-9001", 	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Virtua Fighter (Japan)", "Fixes graphical glitches." },
 { "MK-81005",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Virtua Fighter (USA)", "Fixes graphical glitches." },
 { "MK_8100550",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Virtua Fighter (Europe)", "Fixes graphical glitches." },
 { "GS-9039",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Virtua Fighter Remix (Japan)", "Fixes graphical glitches." },
 { "MK-81023",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Virtua Fighter Remix (USA)", "Fixes graphical glitches." },
 { "MK-8102350",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Virtua Fighter Remix (Europe)", "Fixes graphical glitches." },
 { "SG-7103",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Virtua Fighter Remix (SegaNet)", "Fixes graphical glitches." },
 { "T-36102G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Whizz (Japan)", 	"Fixes quasi-random hangs during startup." },
 { "T-9515H-50",NULL, NULL, CPUCACHE_EMUMODE_FULL, "Whizz (Europe)", 	"Fixes quasi-random hangs during startup." },
 { "T-28004G",	NULL, NULL, CPUCACHE_EMUMODE_FULL, "Yu-No (Japan)",	"Fixes FMV ending too soon." },
 // DMA overhead sensitive games, may be fragile:
#if 0
 { "T-38001G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Another Memories (Japan)", "Fixes game hang." },
 { "T-27810G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Device Reign (Japan)",	"Fixes game hang." },
 { "T-30002G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Real Sound - Kaze no Regret (Japan)", "Fixes game hang." },
 { "T-13324G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"SD Gundam G Century S (Japan)", "Fixes game hang." },
 { "T-26413G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Super Tempo (Japan)",	"Fixes game hang." },
 { "T-17703G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Tennis Arena (Japan)",	"Fixes game hang." },
 { "T-32508G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Tilk - Aoi Umi kara Kita Shoujo (Japan)", "Fixes game hang." },
 { "6106602",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Yuukyuu Gensoukyoku Demo (Japan)", "Fixes game hang." },
 { "T-27804G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Yuukyuu Gensoukyoku (Japan)", "Fixes game hang." },
 { "T-27806G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Yuukyuu no Kobako Official Collection (Japan)", "Fixes game hang." },
 { "T-27807G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Yuukyuu Gensoukyoku 2nd Album (Japan)", "Fixes game hang." },
 { "T-27808G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Yuukyuu Gensoukyoku ensemble (Japan)", "Fixes game hang." },
 { "T-27809G",	NULL, NULL, CPUCACHE_EMUMODE_FULL,		"Yuukyuu Gensoukyoku ensemble 2 (Japan)", "Fixes game hang." },
...
} hhdb[] =
{
 ...
 { "T-31505G", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,	"Falcom Classics II (Japan)", "Fixes FMV tearing in \"Ys II\"." },
 ...
 { "T-23001H", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN, "Herc's Adventures (USA)", "Fixes some sprite flickering and tearing." },
 { "T-9504G", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,	"Tokimeki Memorial - Forever with You (Japan)", "Fixes glitchy frames on the Konami intro arm sprite." },
 { "T-15006G",  HORRIBLEHACK_VDP1RWDRAWSLOWDOWN, "Kaitei Daisensou (Japan)", "Fixes FMV tearing." },
 { "T-10001G", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN, "In The Hunt (Europe/USA)", "Fixes FMV tearing." },
 { "GS-9001", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,	"Virtua Fighter (Japan)", "Fixes graphical glitches." },
 { "MK-81005", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,	"Virtua Fighter (USA)", "Fixes graphical glitches." },
 { "MK_8100550", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,"Virtua Fighter (Europe)", "Fixes graphical glitches." },
 { "GS-9039", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,	"Virtua Fighter Remix (Japan)", "Fixes graphical glitches." },
 { "MK-81023", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,	"Virtua Fighter Remix (USA)", "Fixes graphical glitches." },
 { "MK-8102350", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,"Virtua Fighter Remix (Europe)", "Fixes graphical glitches." },
 { "SG-7103", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,	"Virtua Fighter Remix (SegaNet)", "Fixes graphical glitches." },
 ...
 { "T-26105G", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN, "Wolf Fang SS - Kuuga 2001 (Japan)", "Fixes graphical glitches." },
 { "T-28004G", HORRIBLEHACK_VDP1RWDRAWSLOWDOWN,	"Yu-No (Japan)", "Reduces FMV tearing." },

/*
 // Doesn't completely fix the problem.
 { "T-12519H", HORRIBLEHACK_SCUINTDELAY,	"Loaded (USA)", "Fixes hang at end of level." },
 { "T-12301H", HORRIBLEHACK_SCUINTDELAY,	"Loaded (Europe)", "Fixes hang at end of level." },
 { "T-12504G", HORRIBLEHACK_SCUINTDELAY,	"Blood Factory (Japan)", "Fixes hang at end of level." },
*/
